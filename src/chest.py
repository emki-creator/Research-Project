...
def run_model():
	with strategy.scope():
		pretrained_autoencoder = autoencoder(weights='PATH TO PRE-TRAINED WEIGHT FILE', input_shape=(image_size, image_size,3))
...
for i in range(5):
    ...
    train_generator = datagen.flow_from_directory(
      '/home/data_shares/CATSemilie/data/chest_xray/train',
      class_mode='binary',
      #label_mode=None,
    ...
    validation_generator = datagen_u.flow_from_directory(
      '/home/data_shares/CATSemilie/data/chest_xray/val',
      class_mode='binary',
      target_size=(image_size, image_size),
      shuffle=False,
      seed=43,
    ...
    test_generator = datagen_u.flow_from_directory(
      '/home/data_shares/CATSemilie/data/chest_xray/test',
      class_mode='binary',
      target_size=(image_size, image_size),
      shuffle=False,
      seed=43,
