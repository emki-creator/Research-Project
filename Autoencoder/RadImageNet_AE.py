...
with strategy.scope():
	...
	train_ds = datagen.flow_from_directory(
		directory = '/home/data_shares/CATSemilie/data/radiology_ai',
	...
	print('i am running')
	filepath="model-runs/radimagenet.h5"
...
autoencoder.save('models/AE_RadImageNet.h5')
...
df_loss.to_csv("model-runs/callback__AE_RadImageNet.csv", index=False)
